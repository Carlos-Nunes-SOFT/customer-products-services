...
public class CardBuilderImpl implements CardBuilder{
    ...
    @Override
    public CardBuilder newCard(PropertyStatus propertyStatus, Long subProductId, Long productId,
                               String nameInCard, String cardType, String cardNumber) {
        card = new Card(propertyStatus, subProductId, productId, nameInCard, cardType, cardNumber);
        return this;
    }
}
